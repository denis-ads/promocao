...
public class CampanhaEndpoint {
    ...
    private final Logger LOGGER = Logger.getLogger("CampanhaEndpoint");
    ...
    public Response create(Campanha entity) {
        try {
            entity = campanhaService.cadastrarCampanha(entity);
    ...
    public Response findById(@PathParam("id") Long id) {
        try {
            final Campanha entity = campanhaService.findById(id);
